        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div class="space-y-4">
            ...
            <%= if @show_attachment_modal do %>
              <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" phx-click="close-modal">
                <div class="bg-white rounded-lg p-6 max-w-sm mx-4" phx-click-away="close-modal">
                  <div class="flex items-center justify-between mb-4">
                    ...
                    <button type="button" phx-click="close-modal" class="text-gray-400 hover:text-gray-600">
                  ...
                  <div class="space-y-3">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-gray-900 bg-gray-50 p-2 rounded mt-1">
                        <%= cond do
                          String.contains?(@selected_attachment || "", "voice_memo") -> "Voice Memo (WebM Audio)"
                          String.contains?(@selected_attachment || "", ".mp4") -> "MP4 Video"
                          String.contains?(@selected_attachment || "", ".mov") -> "MOV Video"
                          String.contains?(@selected_attachment || "", ".webm") -> "WebM Video"
                          true -> "Image File"
                        end %>
                      </p>
                    </div>
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                      <div class="flex">
                        <.icon name="hero-exclamation-triangle" class="w-5 h-5 text-yellow-400 mr-2 mt-0.5" />
                        <div>
